...
edges_blur = cv2.Canny(image=img_blur, threshold1=a/2, threshold2=a/10)
edges_blur = cv2.dilate(edges_blur, kernel, iterations=1)
...
# plot imagens
imagens = [img, img_blur, img_gray, edges_gray, edges_blur, final]
